...
##################
# dataset_files <- c("~/Dropbox/FIGURES/Flow_variant_scoring/SplitThreader.1kb_cov.sensitive.SRVs.csv","~/Dropbox/FIGURES/Flow_variant_scoring/SplitThreader.10kb_cov.sensitive.SRVs.csv")
# dataset_names <- c("1 kb bins","10 kb bins")
# output_filename <- "~/Dropbox/FIGURES/Flow_variant_scoring/1kb_vs_10kb_cov_bins.Feb7_Sniffles.sensitive_SplitThreader.png"
##################


##################
dataset_files <- c("~/Dropbox/FIGURES/Flow_variant_scoring/SplitThreader.1kb_cov.stringent.SRVs.csv","~/Dropbox/FIGURES/Flow_variant_scoring/SplitThreader.10kb_cov.stringent.SRVs.csv")
dataset_names <- c("1 kb bins","10 kb bins")
output_filename <- "~/Dropbox/FIGURES/Flow_variant_scoring/1kb_vs_10kb_cov_bins.Feb7_Sniffles.stringent_SplitThreader.png"
##################
